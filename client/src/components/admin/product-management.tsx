...
export default function ProductManagement() {
  ...
  const openEditDialog = (subcategory: Subcategory) => {
    ...
    form.setValue("price", subcategory.price);
    form.setValue("badge", subcategory.badge || "");
    form.setValue("wbUrl", subcategory.wbUrl);
      ...
      <div className="space-y-4">
        <div>
          ...
          <Select value={selectedCategoryId?.toString() || ""} onValueChange={(value) => setSelectedCategoryId(parseInt(value))}>
            <SelectTrigger>
              <SelectValue placeholder="Выберите категорию для управления товарами" />
            </SelectTrigger>
            <SelectContent>
          ...
          <div className="flex justify-between items-center">
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="max-w-md">
                <DialogHeader>
                  <DialogTitle>
                    {editingSubcategory ? "Редактировать товар" : "Создать товар"}
                  </DialogTitle>
                </DialogHeader>
                <Form {...form}>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Select value={field.value || ""} onValueChange={field.onChange}>
                              ...
                              <SelectContent>
                                <SelectItem value="">Без метки</SelectItem>
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {subcategory.badge && (
                          <Badge className={getBadgeColor(subcategory.badge)}>
                            {subcategory.badge}
                          </Badge>
                        )}
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-lg font-bold text-primary">{subcategory.price}</span>
                        <a
                          href={subcategory.wbUrl}
                          target="_blank"
